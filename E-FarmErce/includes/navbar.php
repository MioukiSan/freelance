...
<nav class="navbar navbar-expand-lg">
  <div class="container">
    <a class="navbar-brand" href="./index.php"> <img src="./images/logo.png" style="width: 5.5em;"></a>
        ...
        <?php else: ?>
          <ul class="nav-item pt-4 d-flex">
            ...
            <?php } elseif( $info['user_type'] == 'Admin'){ ?>
              <a class="btn position-relative" data-bs-toggle="tooltip" data-bs-title="SWITCH TO SELLER MODE" style=" color: green;" href="./dashboard_admin.php"><ion-icon size="large" name="swap-horizontal-outline"></ion-icon></a>
            <?php } ?>
            ...
            <tr>
                  ...
                  <td>
                      ...
                      <form method="POST">
                        ...
                        <button type="submit" name="cart_delete" class="btn btn-light float-end"><ion-icon name="trash-outline"></ion-icon></button>
                    </form>
                  </td>
